...
\begin{figure}[h]
	\includegraphics[width=0.7\paperwidth]{reference_architecture}	%TODO: ref gfx
...
\begin{figure}[h]
	\includegraphics[width=0.7\paperwidth]{swap_contract}	%TODO: ref gfx
...
\begin{figure}[h]
	\includegraphics[width=0.7\paperwidth]{swaps-crop}	%TODO: ref gfx MB put in middleware chapter
...
% was ich gerne noch machen wuerde
